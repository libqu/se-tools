...
def svg_text_to_paths(in_svg: Path, out_svg: Path, remove_style=True) -> None:
	...
	font_paths = []
	name_list = {"league_spartan": ["league-spartan-bold.svg"], "sorts_mill_goudy": ["sorts-mill-goudy-italic.svg", "sorts-mill-goudy.svg"], "SourceHanSansHC": ["SourceHanSansHC-Regular.svg"]}
